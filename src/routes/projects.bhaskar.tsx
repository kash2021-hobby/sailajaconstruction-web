...
import bhaskarImage from "@/assets/bhaskarimg/sailajabhaskarresideny.webp";

export const Route = createFileRoute("/projects/bhaskar")({
  head: () => ({
    meta: [
      { title: "Sailaja's Bhaskar Residency — Completed Residential Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Bhaskar Residency — a completed residential project in Mathuranagar, Guwahati offering 2 & 3BHK apartments with modern amenities." },
      { property: "og:title", content: "Sailaja's Bhaskar Residency — Elegant Residential Living in Mathuranagar, Guwahati" },
      { property: "og:description", content: "A completed residential development offering thoughtfully designed 2 & 3BHK apartments in Mathuranagar, Guwahati, Assam." },
      { property: "og:url", content: "/projects/bhaskar" },
    ],
    links: [{ rel: "canonical", href: "/projects/bhaskar" }],
  }),
...
const specs = [
  ...
  { label: "Location", value: "Mathuranagar, Guwahati, Assam" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-black leading-tight">
                Sailaja's<br />Bhaskar Residency
              </h1>
              <p className="mt-4 text-base md:text-lg text-white/80 font-semibold">
                Elegant Residential Living in Mathuranagar, Guwahati
              </p>
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Bhaskar Residency — an elegant residential development by Sailaja Construction in Mathuranagar, Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, and quality construction.
              </p>
            ...
            >
              <Img
                src={bhaskarImage}
                alt="Sailaja's Bhaskar Residency building exterior"
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              Elegant Residential Living at Bhaskar Residency
            </h2>
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Bhaskar Residency is an elegant residential development crafted by Sailaja Construction in Mathuranagar, Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with a Vastu-compliant layout, modern amenities, and quality construction, the project offers comfortable living in a well-connected neighborhood.
            </p>
          </motion.div>
          <motion.div
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/bhaskar/floor-plan-ground.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/bhaskar/floor-plan-typical.jpg"
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              Find Us at Mathuranagar, Guwahati
            </h2>
          </motion.div>
          ...
          >
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Bhaskar%20Residency%20Mathuranagar%20Guwahati%20Assam&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              ...
              title="Sailaja's Bhaskar Residency Location"
            />
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Bhaskar Residency, Mathuranagar, Guwahati, Assam
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Bhaskar+Residency+Mathuranagar+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja's Bhaskar Residency is officially registered under the Assam Real Estate Regulatory Authority (RERA), ensuring full transparency and compliance for our buyers.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/bhaskar/rera1.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/bhaskar/rera2.jpg"
          ...
          >
            <div>
              ...
              <h3 className="text-2xl md:text-4xl font-black text-[var(--charcoal)] leading-tight">
                Interested in Sailaja's<br className="md:hidden" /> Bhaskar Residency?
              </h3>
