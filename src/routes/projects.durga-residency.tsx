...
import { MapPin, Ruler, ArrowRight, Building2, CheckCircle2, ExternalLink, ShieldCheck } from "lucide-react";
...
export const Route = createFileRoute("/projects/durga-residency")({
  head: () => ({
    meta: [
      { title: "Sailaja's Durga Residency — RERA-Certified Completed Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Durga Residency — a RERA-certified completed residential project in Guwahati offering modern apartments with quality construction." },
      { property: "og:title", content: "Sailaja's Durga Residency — RERA-Certified Residential Living in Guwahati" },
      { property: "og:description", content: "A RERA-certified completed residential development offering thoughtfully designed apartments in Guwahati, Assam." },
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Durga Residency — an elegant RERA-certified residential development by Sailaja Construction in the heart of Guwahati. Thoughtfully designed apartments offering comfort, modern amenities, quality construction, and full regulatory compliance for complete peace of mind.
              </p>
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              RERA-Certified Living at Durga Residency
            </h2>
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Durga Residency is an elegant RERA-certified residential development crafted by Sailaja Construction in the heart of Guwahati. Featuring thoughtfully designed apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project is officially registered under the Assam Real Estate Regulatory Authority (RERA No. {reraNumber}), ensuring full transparency, accountability, and peace of mind for our buyers.
            </p>
          </motion.div>
          <motion.div
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8 bg-[var(--soft-gray)]">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            {[unitTypeA, unitTypeB].map((unit, idx) => (
              <motion.div
                key={unit.type}
                variants={reduced ? undefined : fadeUp}
                initial="hidden"
              ...
              >
                ...
                <div className="mb-5 bg-white border border-[var(--border)] rounded-lg p-2 shadow-sm">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-gradient-to-br from-[var(--soft-gray)] to-white flex items-center justify-center">
                    <Img
                      src={`/images/projects/durga-residency/${idx === 0 ? "unit-a-plan" : "unit-b-plan"}.jpg`}
                      alt={`Unit ${idx === 0 ? "A" : "B"} Floor Plan — TODO: Add image`}
                      className="w-full h-full object-contain p-2"
                    />
                  </div>
                  <div className="mt-2 text-center">
                    <div className="text-xs font-bold text-[var(--charcoal)]">Unit {idx === 0 ? "A" : "B"} Floor Plan — TODO: Add image</div>
                  </div>
                </div>
              </motion.div>
            ))}
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/durga-residency/combined-floor-plan.jpg"
                    alt="Combined Floor Plan (Type A & Type B) — TODO: Add combined-floor-plan.jpg"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="mt-3 text-center">
                  <div className="text-sm font-bold text-[var(--charcoal)]">Combined Floor Plan (Type A & Type B) — TODO: Add combined-floor-plan.jpg</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja's Durga Residency
              The pin location is approximate until exact street address is provided.
            */}
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Durga%20Residency%20Guwahati%20Assam&t=&z=14&ie=UTF8&iwloc=&output=embed"
              width="100%"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Durga Residency, Guwahati, Assam [TODO: Add specific street address]
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Durga+Residency+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja's Durga Residency is officially registered under the Assam Real Estate Regulatory Authority (RERA) with registration number {reraNumber}, ensuring full transparency, accountability, and compliance for our buyers.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/durga-residency/rera1.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/durga-residency/rera2.jpg"
