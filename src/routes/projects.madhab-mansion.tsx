...
import { MapPin, Ruler, ArrowRight, Building2, CheckCircle2, ExternalLink } from "lucide-react";
...
import madhabHeroImage from "@/assets/madhabmansionimg/madhobmansion.webp";

export const Route = createFileRoute("/projects/madhab-mansion")({
  head: () => ({
    meta: [
      { title: "Sailaja's Madhab Mansion — Completed Residential Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Madhab Mansion — a completed residential project in Guwahati offering 2 & 3BHK apartments with modern amenities." },
      { property: "og:title", content: "Sailaja's Madhab Mansion — Elegant Residential Living in Guwahati" },
...
const highlights = [
  ...
  { icon: Ruler, label: "Area", value: "1000+ Sq.Ft" },
...
const unitTypeA = {
  type: "UNIT TYPE A — 3BHK",
  bua: "BUA: 1072 Sq.Ft",
  sbua: "SBUA: 1340 Sq.Ft",
  dimensions: "[TODO: Add from brochure if available]",
};

const unitTypeB = {
  type: "UNIT TYPE B — 3BHK",
  bua: "BUA: 1000 Sq.Ft",
  sbua: "SBUA: 1250 Sq.Ft",
  dimensions: "[TODO: Add from brochure if available]",
};
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Madhab Mansion — an elegant residential development by Sailaja Construction in the heart of Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, and quality construction.
              </p>
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              Elegant Residential Living at Madhab Mansion
            </h2>
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Madhab Mansion is an elegant residential development crafted by Sailaja Construction in the heart of Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project offers comfortable and contemporary living in a well-connected neighborhood.
            </p>
          </motion.div>
          <motion.div
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div>
                    ...
                    <h3 className="text-base md:text-lg font-black text-[var(--charcoal)] mt-1">{unit.bua}</h3>
                    <h3 className="text-sm md:text-base font-bold text-[var(--charcoal)] mt-0.5">{unit.sbua}</h3>
                  </div>
                </div>
                ...
                <div className="mb-5 bg-white border border-[var(--border)] rounded-lg p-2 shadow-sm">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-gradient-to-br from-[var(--soft-gray)] to-white flex items-center justify-center">
                    <Img
                      src={`/images/projects/madhab-mansion/${idx === 0 ? "unit-a-plan" : "unit-b-plan"}.jpg`}
                      alt={`Unit ${idx === 0 ? "A" : "B"} Floor Plan — TODO: Add image`}
                      className="w-full h-full object-contain p-2"
                    />
                  </div>
                  <div className="mt-2 text-center">
                    <div className="text-xs font-bold text-[var(--charcoal)]">{idx === 0 ? "Unit A" : "Unit B"} Floor Plan — TODO: Add image</div>
                  </div>
                </div>

                <div className="text-xs md:text-sm text-muted-foreground italic">
                  Room dimensions: [TODO: Add from brochure if available]
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-3 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Typical Floor Plan (1<sup>st</sup> – 3<sup>rd</sup> Floor)
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/madhab-mansion/typical-floor-plan.jpg"
                    alt="TYPICAL FLOOR PLAN (1ST - 3RD) — TODO: Add typical-floor-plan.jpg"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="mt-3 text-center">
                  <div className="text-sm font-bold text-[var(--charcoal)]">TYPICAL FLOOR PLAN (1ST - 3RD) — TODO: Add typical-floor-plan.jpg</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja's Madhab Mansion
              The pin location is approximate until exact street address is provided.
            */}
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Madhab%20Mansion%20Guwahati%20Assam&t=&z=14&ie=UTF8&iwloc=&output=embed"
              width="100%"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Madhab Mansion, Guwahati, Assam [TODO: Add specific street address/locality]
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Madhab+Mansion+Guwahati"
              target="_blank"
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/madhab-mansion/rera1.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/madhab-mansion/rera2.jpg"
