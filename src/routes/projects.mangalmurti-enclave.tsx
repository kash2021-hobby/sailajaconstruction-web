...
export const Route = createFileRoute("/projects/mangalmurti-enclave")({
  head: () => ({
    meta: [
      { title: "Sailaja's Mangalmurti Enclave — RERA-Certified Completed Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Mangalmurti Enclave — a RERA-certified completed residential project in Guwahati offering 2 & 3BHK apartments with quality construction." },
      { property: "og:title", content: "Sailaja's Mangalmurti Enclave — RERA-Certified Residential Living in Guwahati" },
      { property: "og:description", content: "A RERA-certified completed residential development offering thoughtfully designed 2 & 3BHK apartments in Guwahati, Assam." },
...
const specs = [
  ...
  { label: "Units per Floor", value: "3 (Unit A, Unit B, Unit C)" },
  { label: "Location", value: "Rangamatir Path, Sachal, Guwahati, Assam [TODO: Confirm specific locality]" },
...
const allUnits = [unitTypeA, unitTypeB, unitTypeC];
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-base md:text-lg text-white/80 font-semibold">
                Elegant RERA-Certified Residential Living in the Heart of Guwahati
              </p>
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Mangalmurti Enclave — an elegant RERA-certified residential development by Sailaja Construction in the heart of Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, quality construction, and full regulatory compliance for complete peace of mind.
              </p>
            ...
            >
              <Img
                src={mangalImg}
                alt="Sailaja's Mangalmurti Enclave"
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              RERA-Certified Living at Mangalmurti Enclave
            </h2>
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Mangalmurti Enclave is an elegant RERA-certified residential development crafted by Sailaja Construction in the heart of Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project is officially registered under the Assam Real Estate Regulatory Authority (RERA No. {reraNumber}), ensuring full transparency, accountability, and peace of mind for our buyers.
            </p>
          </motion.div>
          <motion.div
              ...
              >
                ...
                <div className="mb-5 bg-white border border-[var(--border)] rounded-lg p-2 shadow-sm">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-gradient-to-br from-[var(--soft-gray)] to-white flex items-center justify-center">
                    <Img
                      src={`/images/projects/mangalmurti-enclave/unit-${["a", "b", "c"][idx]}-plan.jpg`}
                      alt={`Unit ${["A", "B", "C"][idx]} Floor Plan — TODO: Add image`}
                      className="w-full h-full object-contain p-2"
                    />
                  </div>
                  <div className="mt-2 text-center">
                    <div className="text-xs font-bold text-[var(--charcoal)]">Unit {["A", "B", "C"][idx]} Floor Plan — TODO: Add {["unit-a-plan", "unit-b-plan", "unit-c-plan"][idx]}.jpg</div>
                  </div>
                </div>

                <div className="text-xs md:text-sm text-muted-foreground italic">
                  Room dimensions: [TODO: Add from brochure]
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-3 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Typical Floor Plan showing Units A, B & C
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/mangalmurti-enclave/typical-floor-plan.jpg"
                    alt="Typical Floor Plan (Units A, B & C) — TODO: Add typical-floor-plan.jpg"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="mt-3 text-center">
                  <div className="text-sm font-bold text-[var(--charcoal)]">Typical Floor Plan (Units A, B & C) — TODO: Add typical-floor-plan.jpg</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja's Mangalmurti Enclave
              The pin location is approximate until exact street address is provided.
              Note: The company office is listed at "Unit G1, Ground Floor, Mangalmaruti Enclave"
            */}
            <iframe
              src="https://maps.google.com/maps?q=Mangalmurti%20Enclave%20Sachal%20Path%20Guwahati%20Assam&t=&z=14&ie=UTF8&iwloc=&output=embed"
              width="100%"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Mangalmurti Enclave, Rangamatir Path, Sachal, Guwahati - 781036, Assam
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Mangalmurti+Enclave+Sachal+Path+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja's Mangalmurti Enclave is officially registered under the Assam Real Estate Regulatory Authority (RERA) with registration number {reraNumber}, ensuring full transparency, accountability, and compliance for our buyers.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/mangalmurti-enclave/rera1.jpg"
                    alt="RERA Certificate — Page 1 — TODO: Add rera1.jpg"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="mt-3 text-center">
                  <div className="text-sm font-bold text-[var(--charcoal)]">RERA Certificate — Page 1 — TODO: Add rera1.jpg</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/mangalmurti-enclave/rera2.jpg"
                    alt="RERA Certificate — Page 2 — TODO: Add rera2.jpg"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="mt-3 text-center">
                  <div className="text-sm font-bold text-[var(--charcoal)]">RERA Certificate — Page 2 — TODO: Add rera2.jpg</div>
                </div>
              </div>
            </motion.div>
          </div>
