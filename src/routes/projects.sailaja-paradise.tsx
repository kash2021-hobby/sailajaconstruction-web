...
export const Route = createFileRoute("/projects/sailaja-paradise")({
  head: () => ({
    meta: [
      { title: "Sailaja Paradise — RERA-Certified Completed Residential Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja Paradise — a RERA-certified completed residential project in Guwahati offering 2 & 3BHK apartments with quality construction." },
      { property: "og:title", content: "Sailaja Paradise — RERA-Certified Residential Living in Guwahati" },
...
const reraNumber = "NN 128 OF 2023-2024";

const highlights = [
  { icon: MapPin, label: "Location", value: "Guwahati, Assam" },
  { icon: Maximize, label: "Area", value: "1450 Sq.Ft" },
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Sailaja Paradise — an elegant RERA-certified residential development by Sailaja Construction in the heart of Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, quality construction, and full regulatory compliance for complete peace of mind.
              </p>
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja Paradise is an elegant RERA-certified residential development crafted by Sailaja Construction in the heart of Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project is officially registered under the Assam Real Estate Regulatory Authority (RERA No. {reraNumber}), ensuring full transparency, accountability, and peace of mind for our buyers.
            </p>
          </motion.div>
          <motion.div
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <h2 className="mt-3 text-2xl md:text-3xl lg:text-4xl text-[var(--charcoal)]">
              Comprehensive Building Layouts
            </h2>
            <p className="mt-3 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Explore the parking, typical floor, and terrace plans
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              { label: "PARKING PLAN", img: "parking-plan.jpg", alt: "Parking Plan" },
              { label: "TYPICAL PLAN", img: "typical-plan.jpg", alt: "Typical Plan" },
              { label: "TERRACE PLAN", img: "terrace-plan.jpg", alt: "Terrace Plan" },
            ].map((plan, idx) => (
              <motion.div
                key={plan.label}
                variants={reduced ? undefined : fadeUp}
              ...
              >
                ...
                <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center p-4">
                      <p className="text-xs text-muted-foreground/60 font-semibold">{plan.alt} — TODO: Add {plan.img}</p>
                    </div>
                  </div>
                </div>
                <div className="mt-2 text-center">
          ...
          >
            ...
            <div className="text-[10px] md:text-xs text-muted-foreground mt-2 text-center">
              Compass orientation for all floor plans
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja Paradise
              The pin location is approximate until exact street address is provided.
            */}
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Paradise%20Guwahati%20Assam&t=&z=14&ie=UTF8&iwloc=&output=embed"
              width="100%"
              ...
              title="Sailaja Paradise Location"
            />
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja Paradise, Guwahati, Assam [TODO: Add specific street address/locality]
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Paradise+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja Paradise is officially registered under the Assam Real Estate Regulatory Authority (RERA) with registration number {reraNumber}, ensuring full transparency, accountability, and compliance for our buyers.
            </p>
          ...
          >
            <div>
              ...
              <h3 className="text-2xl md:text-4xl font-black text-[var(--charcoal)] leading-tight">
                Interested in Sailaja Paradise?
              </h3>
