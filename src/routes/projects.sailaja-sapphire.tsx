...
import { MapPin, Home, ArrowRight, Building2, CheckCircle2, ExternalLink, ShieldCheck, Maximize } from "lucide-react";
...
import sapphireHeroImage from "@/assets/sailajasapphireimg/saphire.webp";

export const Route = createFileRoute("/projects/sailaja-sapphire")({
  head: () => ({
    meta: [
      { title: "Sailaja's Sapphire — RERA-Certified Completed Residential Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Sapphire — a RERA-certified completed residential project in Panjabari, Guwahati offering 2 & 3BHK apartments with quality construction." },
      { property: "og:title", content: "Sailaja's Sapphire — RERA-Certified Residential Living in Panjabari, Guwahati" },
      { property: "og:description", content: "A RERA-certified completed residential development offering thoughtfully designed 2 & 3BHK apartments in Panjabari, Guwahati, Assam." },
...
const highlights = [
  { icon: MapPin, label: "Location", value: "Panjabari, Guwahati, Assam" },
  { icon: Maximize, label: "Area", value: "1250 Sq.Ft" },
...
const specs = [
  ...
  { label: "Location", value: "Panjabari, Guwahati, Assam [TODO: Add specific street address]" },
...
const unitTypeA = {
  type: "UNIT TYPE A",
  config: "[TODO: Confirm BHK from brochure — likely 2BHK]",
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-base md:text-lg text-white/80 font-semibold">
                Elegant RERA-Certified Residential Living in Panjabari, Guwahati
              </p>
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Sailaja's Sapphire — an elegant RERA-certified residential development by Sailaja Construction in Panjabari, Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, quality construction, and full regulatory compliance for complete peace of mind.
              </p>
            ...
            >
              <Img
                src={sapphireHeroImage}
                alt="Sailaja's Sapphire"
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Sapphire is an elegant RERA-certified residential development crafted by Sailaja Construction in Panjabari, Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project is officially registered under the Assam Real Estate Regulatory Authority (RERA No. {reraNumber}), ensuring full transparency, accountability, and peace of mind for our buyers.
            </p>
          </motion.div>
          <motion.div
            ...
            {allUnits.map((unit, idx) => (
              ...
              >
                ...
                <div className="text-xs md:text-sm text-muted-foreground">
                  {Array.isArray(unit.dimensions) ? (
                    <div>
                      <div className="font-bold text-[var(--charcoal)] mb-1">Room Dimensions:</div>
                      <ul className="space-y-0.5">
                        {unit.dimensions.map((d) => (
                          <li key={d} className="italic">{d}</li>
                        ))}
                      </ul>
                    </div>
                  ) : (
                    <div className="italic">{unit.dimensions}</div>
                  )}
                </div>
              </motion.div>
            ))}
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-3 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Detailed floor plan for Flat Type B (3BHK)
            </p>
          </motion.div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <div className="text-xs font-bold text-[var(--charcoal)] uppercase tracking-wider mb-2 text-center">
                FLAT TYPE B : 3BHK | BUA 1000 SQ.FT | SBUA 1250 SQ.FT
              </div>
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-4">
                    <p className="text-xs text-muted-foreground/60 font-semibold">Flat Type B Floor Plan — TODO: Add flat-type-b-plan.jpg</p>
                  </div>
                </div>
              </div>
              <div className="mt-2 text-center">
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja's Sapphire
              The pin location is approximate until exact street address is provided.
            */}
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Sapphire%20Panjabari%20Guwahati%20Assam&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Sapphire, Panjabari, Guwahati, Assam [TODO: Add specific street address]
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Sapphire+Panjabari+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja's Sapphire is officially registered under the Assam Real Estate Regulatory Authority (RERA) with registration number {reraNumber}, ensuring full transparency, accountability, and compliance for our buyers.
            </p>
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center p-4">
                      <p className="text-xs text-muted-foreground/60 font-semibold">RERA Certificate — Page 1 — TODO: Add rera1.jpg</p>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center p-4">
                      <p className="text-xs text-muted-foreground/60 font-semibold">RERA Certificate — Page 2 — TODO: Add rera2.jpg</p>
                    </div>
                  </div>
                </div>
                <div className="mt-3 text-center">
