...
export const Route = createFileRoute("/projects/shree-bishnu-commercial")({
  head: () => ({
    meta: [
      { title: "Shree Bishnu Commercial — Upcoming Commercial Project | Sailaja Constructions" },
      { name: "description", content: "Explore Shree Bishnu Commercial — an upcoming commercial project by Sailaja Constructions designed for modern businesses and retail spaces." },
      { property: "og:title", content: "Shree Bishnu Commercial — Upcoming Commercial Project in Assam" },
      { property: "og:description", content: "An upcoming commercial project designed for modern businesses and retail spaces by Sailaja Constructions." },
      { property: "og:url", content: "/projects/shree-bishnu-commercial" },
    ],
    links: [{ rel: "canonical", href: "/projects/shree-bishnu-commercial" }],
  }),
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                An upcoming commercial project designed for modern businesses and retail spaces by Sailaja Constructions.
              </p>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-lg mx-auto">
              The detailed information for <strong>Shree Bishnu Commercial</strong> is currently under preparation. We are working on finalizing the specifications, floor plans, and pricing details. Please check back soon or contact us for more information.
            </p>
          ...
          >
            <div>
              ...
              <h3 className="text-2xl md:text-4xl font-black text-[var(--charcoal)] leading-tight">
                Interested in Shree Bishnu Commercial?
              </h3>
