...
import xopunHero from "@/assets/xopunaloyimg/xopunaloy.webp";

export const Route = createFileRoute("/projects/xopun-aloy")({
  head: () => ({
    meta: [
      { title: "Sailaja's Xopun Aloy — Completed Residential Project in Guwahati | Sailaja Constructions" },
      { name: "description", content: "Explore Sailaja's Xopun Aloy — a completed residential project in Guwahati offering 2 & 3BHK apartments with modern amenities." },
      { property: "og:title", content: "Sailaja's Xopun Aloy — Elegant Residential Living in Guwahati" },
      ...
      { property: "og:url", content: "/projects/xopun-aloy" },
    ],
    links: [{ rel: "canonical", href: "/projects/xopun-aloy" }],
  }),
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/65 leading-relaxed max-w-xl">
                Welcome to Xopun Aloy — an elegant residential development by Sailaja Construction in the heart of Guwahati. Thoughtfully designed 2BHK and 3BHK apartments offering comfort, modern amenities, and quality construction.
              </p>
        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl text-[var(--charcoal)]">
              Elegant Residential Living at Xopun Aloy
            </h2>
            <p className="mt-5 text-sm md:text-base text-muted-foreground leading-relaxed">
              Sailaja's Xopun Aloy is an elegant residential development crafted by Sailaja Construction in the heart of Guwahati. Featuring thoughtfully designed 2BHK and 3BHK apartments with Vastu-compliant layouts, modern amenities, and quality construction, the project offers comfortable and contemporary living in a well-connected neighborhood.
            </p>
          </motion.div>
          <motion.div
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/xopun-aloy/floor-plan-ground.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/xopun-aloy/floor-plan-typical.jpg"
      ...
      <section className="py-12 md:py-20 px-5 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/*
              TODO: Confirm exact address for Sailaja's Xopun Aloy
              The pin location is approximate until exact street address is provided.
            */}
            <iframe
              src="https://maps.google.com/maps?q=Sailaja%20Xopun%20Aloy%20Guwahati%20Assam&t=&z=14&ie=UTF8&iwloc=&output=embed"
              width="100%"
              ...
              title="Sailaja's Xopun Aloy Location"
            />
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm md:text-base text-[var(--charcoal)] font-semibold">
                Sailaja's Xopun Aloy, Guwahati, Assam [TODO: Add specific street address/locality]
              </span>
            </div>
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Sailaja+Xopun+Aloy+Guwahati"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
              Sailaja's Xopun Aloy is officially registered under the Assam Real Estate Regulatory Authority (RERA), ensuring full transparency and compliance for our buyers.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/xopun-aloy/rera1.jpg"
            ...
            >
              <div className="bg-white border border-[var(--border)] rounded-lg p-2 md:p-4 shadow-lg">
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[var(--soft-gray)]">
                  <Img
                    src="/images/projects/xopun-aloy/rera2.jpg"
          ...
          >
            <div>
              ...
              <h3 className="text-2xl md:text-4xl font-black text-[var(--charcoal)] leading-tight">
                Interested in Sailaja's<br className="md:hidden" /> Xopun Aloy?
              </h3>
